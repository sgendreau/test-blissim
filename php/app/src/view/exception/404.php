...
<div class="h-screen justify-center w-full">
    <center class="mt-24 m-auto">
        ...
        <div class=" tracking-widest mt-4">
            ...
            <span class="text-gray-500 text-xl">Désolé, Il nous semble que vous êtes perdu !</span>

        </div>
    </center>
    <center class="mt-6">
        <a href="/" class="text-white bg-gray-300 border-0 py-2 px-8 focus:outline-none hover:bg-gray-500 rounded text-lg">Accueil</a>
    </center>
</div>
<?php
